                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                ...
                                <small>
                                    <c:forEach items="${sessionScope.currentAccount.deptList}" var="dept">
                                        ${dept.deptName} &nbsp;&nbsp;
                                    </c:forEach>
                                </small>
                            </p>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="${param.active == 'home'? 'active' : '' }"><a href="/home"><i class="fa fa-share-alt"></i> <span>首页</span></a></li>
            <!-- 客户管理 -->
            <li class="treeview  ${fn:startsWith(param.active,'customer/') ? 'active':''}">
                <a href="#">
            ...
            <!-- 工作记录 -->
            <li class="treeview ${fn:startsWith(param.active,'/sales') ? 'active' : ''}">
                <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="${param.active == '/sales/my' ? 'active' : ''}"><a href="/sales/my"><i class="fa fa-circle-o"></i> 我的记录</a></li>
                    <li><a href="/recode/public"><i class="fa fa-circle-o"></i> 公共记录</a></li>
                </ul>
            </li>
            <!-- 待办事项 -->
            <li class="treeview ${fn:startsWith(param.active,'/task') ? 'active': ''}">
                <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="${param.active == '/task/search' ? 'active' : ''}"><a href="/task/search"><i class="fa fa-circle-o"></i> 待办列表</a></li>
